...
# 添加 --search-all-include-packages 标志，支持跨 bundle 非限定资源引用
git apply "patches/search_all_include_packages.patch" || echo "WARNING: search_all_include_packages.patch failed (may already be applied)"
